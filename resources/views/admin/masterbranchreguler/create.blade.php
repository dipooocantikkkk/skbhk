            ...
            <div class="card multisteps-form__panel p-4 border-radius-xl bg-white js-active" data-animation="FadeIn">
              ...
              <div class="row pb-4">
                  <div class="col-4 col-sm-4 mt-10 mt-sm-0">
                    <label>Branch</label>
                    <input id="branch" type="text" class="multisteps-form__input form-control @error('branch') is-invalid @enderror"  name="branch" value="{{ old('branch') }}"required autocomplete="branch" placeholder="Head Office" autofocus/>
                  </div>
                  <div class="col-8">
                      <label>Alamat</label>
              ...
              <div class="row">
                 <div class="col-4">
                  ...
                  <div class="col-4">
                    ...
                    <input id="kota" type="text" class="multisteps-form__input form-control @error('kota') is-invalid @enderror"  name="kota" value="{{ old('kota') }}"required autocomplete="kota"  placeholder="Tanggerang" autofocus/>
                  </div>
              </div>
