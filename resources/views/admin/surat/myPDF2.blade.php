...
<body>
    ...
    <div align="justify">
        <p>
            ...
            <br>
            Terhitung sejak tanggal {{Carbon\Carbon::parse($surat->tgl_awal_hubker)->translatedFormat('j F Y','id')}}, hubungan kerja Sdr/i dengan {{ $surat->ptcv->nama_pt ?? '' }} dinyatakan berakhir, sehingga segala tindakan yang dilakukan oleh Sdr/i tidak memiliki sangkut paut dengan {{ $surat->ptcv->nama_pt ?? '' }} dan PT. Sumber Alfaria Trijaya Tbk.
            <br>
